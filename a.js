...
var prizeGenerator = function(){
  ...
  var prizes =[{name:'Tamagotchi', link: "<img id='theImg' src='https://clipartcraft.com/images/monkey-clipart-face-9.png'/>", text: " Remember to change its diapers."},
  {name:'good job ', link: "<img id='theImg' src='https://clipartcraft.com/images/monkey-clipart-face-9.png'/>", text: " Be sure to feed it twice a day."},
  {name:'Great ', link: "<img id='theImg' src='https://clipartcraft.com/images/monkey-clipart-face-9.png'/>", text: " You're in luck...they love to cuddle."},
  {name:'you made him happy ', link: "<img id='theImg' src='https://clipartcraft.com/images/monkey-clipart-face-9.png'/>", text: ' Because what do dogs love more than blankets with sleaves?'},
  {name:'he is happy now ', link: "<img id='theImg' src='https://clipartcraft.com/images/monkey-clipart-face-9.png'/>", text: " Oh snap!" }];
